...
const char* ssid = "Vinay-Fi";
const char* password = "Patnaik@ff2";

// ===== CHANGE THIS PER DVICE =======
IPAddress local_IP(192,168,29,200);   // Set unique IP for this device
IPAddress peerIP(192,168,29,201);    //  Set IP for other device 
...
void loop(){
  ...
  if(pttPressed){
   ...
   if(isTransmitMode){
    ...
    digitalWrite(MIC_POWER_PIN, LOW);  // Enable DAC
    digitalWrite(DAC_POWER_PIN, HIGH);  //  Disable MIC
   }
